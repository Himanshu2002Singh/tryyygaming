...
function PanelActionsContentWithdraw() {
  ...
  const fetchPanelActions = async () => {
    try {
      ...
      const response = await axios.get(
        `${API_URL}/userpanel/panel-actions?type=withdraw`,
        {
          headers: {
  ...
  const handleRejectAction = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `${API_URL}/panel-actions/${currentAction.id}/status`,
        {
          status: "Rejected",
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:flex-wrap gap-1 sm:gap-4 items-center text-sm">
        <div className="flex flex-col items-start w-full sm:w-auto">
          <label className="text-gray-500 mr-2">Action Type</label>
          <select
        ...
        <div className="flex flex-col items-start w-full sm:w-auto">
          <label className="text-gray-500 mr-2">User Search</label>
              ...
              filteredActions.map((action, index) => (
                ...
                >
                 ...
                 <td className="px-4 sm:py-3 border border-black">
                  ...
                  <td className="px-4 sm:py-3 capitalize border border-black">{action.type}</td>
                  <td className="px-4 sm:py-3 border border-black">{action.coins}</td>
