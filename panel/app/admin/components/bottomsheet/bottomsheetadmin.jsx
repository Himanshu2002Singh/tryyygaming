      ...
      <div
        ...
        className={`flex flex-col justify-between fixed z-50 rounded-lg shadow-xl overflow-y-auto transition-all duration-300 ease-in-out ${
          ...
          isFullscreen
            ...
            : "top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-11/12 sm:w-3/5 md:w-4/7 lg:w-3/7 h-max"
        }`}
      >
        {/* Drag Handle */}
        {dragHandle && (
        ...
        <div
          className={`flex justify-center ${
            isFullscreen ? "h-full" : "max-[800px]:max-h-[40rem] max-h-[55rem]"
          }`}
        >
